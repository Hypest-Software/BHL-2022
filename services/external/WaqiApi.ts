...
const statusRanges = (value: number, table: Map<PollutionStatus, { min: number, max: number }>): PollutionStatus => {
...
export const carbonMonoxiteStatus = (carbonMonoxite: number): PollutionStatus => {
	return statusRanges(carbonMonoxite, new Map([
...
export const nitrogenDioxideStatus = (nitrogenDioxide: number): PollutionStatus => {
	return statusRanges(nitrogenDioxide, new Map([
...
export const ozoneStatus = (ozone: number): PollutionStatus => {
	return statusRanges(ozone, new Map([
...
export const particulateMatter10Status = (particulateMatter: number): PollutionStatus => {
